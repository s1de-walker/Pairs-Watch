...
if not error_flag:
    ...
    if adf_pvalue < 0.05:
        col3.write(f"*:grey[✅ The spread is **stationary** (p-value: {adf_pvalue:.3f})]. It means the SPREAD has a constant mean and variance over time, suggesting a stable relationship that is likely to revert to its average.*")
    else:
